...
/*
    private List<Movie> getMovieDataFromJson (String moviesJsonStr) throws JSONException, InvocationTargetException, IllegalAccessException, NoSuchMethodException {
    ...
    @Override protected List<Movie> doInBackground (String... params) {
        ...
        try {
            ...
            builder.scheme ("https").authority ("api.themoviedb.org").appendPath ("3").appendPath ("discover").appendPath ("movie").appendQueryParameter ("sort_by",
                    translateSortOrder (prefs.getString (mContext.getString (R.string.key_sort_order), mContext.getString (R.string.default_key_sort_order))) + ".desc")
